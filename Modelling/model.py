...
def convolve_and_mask(conv_features, pad_mask, n_filters, kernel_size, suffix, prefix="",
    ...
    if conv_dropout > 0.0:
        conv_features = SpatialDropout1D(dropout, name=prefix+"1d_dropout_"+suffix)(conv_features)
...
def create_model_recurrent(n_conv_layers=3, 
    ...
    lstm_features = LSTM(recurrent_neurons, return_sequences=False, name="recurrent_scanner")(conv_masked)
